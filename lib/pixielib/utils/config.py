...
cfg.pretrained_modelpath = hf_hub_download(
    repo_id="lilpotat/pytorch3d", filename="pixie_model.tar"
)
...
cfg.model.topology_smplxtex_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="smplx_tex.obj"
)
cfg.model.topology_smplx_hand_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="smplx_hand.obj"
)
cfg.model.smplx_model_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="SMPLX_NEUTRAL_2020.npz"
)
cfg.model.face_mask_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="uv_face_mask.png"
)
cfg.model.face_eye_mask_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="uv_face_eye_mask.png"
)
cfg.model.extra_joint_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="smplx_extra_joints.yaml"
)
cfg.model.j14_regressor_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="SMPLX_to_J14.pkl"
)
cfg.model.flame2smplx_cached_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="flame2smplx_tex_1024.npy"
)
cfg.model.smplx_tex_path = hf_hub_download(
    repo_id="lilpotat/pytorch3d",  filename="smplx_tex.png"
)
